              ...
              <div className="lg:col-span-2">
                <div className="glass-card p-6 rounded-2xl">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <Link href="/en/dashboard?tab=projects" className="text-purple-400 hover:text-purple-300 transition-colors">
                      View All
                    </Link>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="glass-card p-6 rounded-2xl">
                  ...
                  <div className="space-y-3">
                    ...
                    <Link href="/en/profile/edit" className="block w-full btn-secondary text-center">
                      Edit Profile
                    </Link>
                  </div>
                </div>
                    ...
                    <tbody className="divide-y divide-gray-800">
                      {filteredProjects.map((project) => (
                        <tr key={project.id} className="hover:bg-gray-800/30 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <div className="text-gray-300">{project.client}</div>
                          </td>
                          <td className="px-6 py-4">
                            <span className={cn(
